 ...
 */
const SkillLevelDialogDesktop = forwardRef<
  HTMLDivElement,
  SkillLevelDialogDesktopProps
>(function SkillLevelDialogDesktop({ name, level, openLeft }, ref) {
  return (
    <LevelDialogPanel
      ref={ref}
      ariaLabel={`${name} 레벨 설명`}
      className={`pointer-events-none z-20 hidden bottom-full -mb-5 w-auto rounded-[30px] p-6 xs:block ${
